...
class RewardViewSet(viewsets.GenericViewSet):
  ...
  def populate(self, pk):
        try:
            ...
            raise Http404("Reward doesn't exist.")
  
  @csrf_exempt
  def create(self, request):
        logger.info('add reward='+str(request.POST);
...
Sample post
{
  ...
  "Subject" : "My First Reward Notification",
  "Message" : "Bonus 5 points",
