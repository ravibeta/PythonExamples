"""
Django settings for jiraapi project.
...
WSGI_APPLICATION = 'jiraapi.wsgi.application'

#ejira settings
MQSERVER = parser.get('mq', 'mq_server')
print ('MQSERVER='+MQSERVER)
SPLUNK_MAP_EMAIL = parser.get('jira','map_jira')
print ('SPLUNK_MAP_EMAIL='+SPLUNK_MAP_EMAIL)
ITC_DEV_MAIL = parser.get('jira','dev_jira')
print ('ITC_DEV_MAIL='+ITC_DEV_MAIL)
ADMIN_EMAIL = parser.get('jira','admin_jira')
print ('ADMIN_EMAIL='+ADMIN_EMAIL)
EMAIL_SUBJECT = parser.get('jira','global_subject')
